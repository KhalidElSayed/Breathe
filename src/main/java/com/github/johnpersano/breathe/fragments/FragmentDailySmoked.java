...
public class FragmentDailySmoked extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
	    ...
	    View mView = inflater.inflate(R.layout.fragment_dailysmoked,
	    		container, false);
        ...
        final int mDailySmoked = mPreferences
        		.getInteger(Preferences.INTEGER_DAILYSMOKED, 10);
        
		mPreferences.saveInteger(Preferences.INTEGER_DAILYSMOKED, mDailySmoked);
	    ...
	    mNumberPicker.setValue(mDailySmoked);
	    mNumberPicker.setOnValueChangedListener(new OnValueChangeListener() {
			...
			public void onValueChange(NumberPicker mNumberPicker, int oldValue, int newValue) {
				...
				mPreferences.saveInteger(Preferences.INTEGER_DAILYSMOKED, newValue);
	...
	public void setUserVisibleHint(boolean isVisibleToUser) {
		...
		if(this.isVisible()) {
			...
			mWizardLocker.unlockPreviousButton();
